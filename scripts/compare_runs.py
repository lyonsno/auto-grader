...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=[],
        help=(
            "Optional label for a run/query. Supply once per resolved run, "
            "in the same order. Defaults to the run directory basename or "
            "the query selector."
        ),
    )
    parser.add_argument(
    ...
    labels = [label for label, _path in labeled_runs]
