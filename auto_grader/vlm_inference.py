...
def _stream_vision_completion_with_finish(
    *,
    config: ServerConfig,
    prompt_text: str,
...
def stream_vision_completion(
    *,
    ...
    content, reasoning, _finish_reason = _stream_vision_completion_with_finish(
        config=config,
...
def grade_single_item(
    ...
    content, reasoning, finish_reason = _stream_vision_completion_with_finish(
        config=config,
        prompt_text=prompt_text,
        page_image=page_image,
