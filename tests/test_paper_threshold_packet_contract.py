...
class PaperThresholdPacketContractTests(unittest.TestCase):
    ...
    def test_threshold_packet_pages_match_public_compact_generation_layout(self) -> None:
        build_mc_threshold_stress_packet = _load_builder(self)
        try:
            from auto_grader.generation import McAnswerSheetLayout, build_mc_answer_sheet_pages
        except ImportError:
            self.fail(
                "Route threshold-stress packet pages through a public generation layout seam "
