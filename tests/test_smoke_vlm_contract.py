...
class SmokeVlmContract(unittest.TestCase):
    ...
    def test_describe_only_mode_accepts_legacy_fifteen_blue_scan_name(self) -> None:
        ...
        extract_mock.assert_called_once_with(scans_dir / "15 blue.pdf", item.page)
        stream_mock.assert_called_once()

    def test_describe_only_mode_prefers_mapped_legacy_fifteen_blue_scan_name(
        self,
    ) -> None:
        item = EvalItem(
            exam_id="15-blue",
